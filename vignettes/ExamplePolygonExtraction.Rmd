...
rainfall = rainfallR::get_rainfall(
  spatial.obj = su,
  dts = day,
  fun = "mean",
  days_back = 1
...
- Now lets transform it into long format and get the cumulative sum j

```{r cumsum}
rainfall_cumsum = rainfallR::make_cumulative_rainfall(rainfall)
```
